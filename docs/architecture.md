...
### Dashboard
![Smart City Dashboard Screenshot](smart_city_dashboard.png)

### Smart City Map 
![Smart City Map Screenshot](smart_city_map.png)

### Ward Analysis
![Each Ward's Analysis Screenshot](smart_city_ward_analysis.png)
